...
class Rectangle:
    ...
    def square(cls, size=0):
        """
        This is a class method in Python that creates a square object
        with a given size.
        ...
        Args:
            ...
            size (int, optional): an integer that represents the height
                and width of a square. Defaults to 0.

        Returns:  an instance of the class with the `width` and `height`
        attributes set to the same value, which is the `size` argument
        """
