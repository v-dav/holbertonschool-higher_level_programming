...
class Square:
    ...
    def __str__(self):
        """This method is for string representation of the square.

        Returns: a string representation of the square. It
        concatenates the string representation of the square, similar to the
        method my_print() and returns the resulting string.
        """
        string = ""
        if self.__size == 0:
            return string
